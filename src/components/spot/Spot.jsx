            ...
            <div className="bottom_side p-5 mt-[40px]  pt-[50px] bg-[#F8F8F8]">
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-10">
                    <div className="right_side pt-[30px]">
                        ...
                        <button className="main_color rounded-[16px] w-[200px] mt-[3vh] sm:mt-[2vh] md:mt-[3vh] text-white font-bold sub_font text-[20px] flex justify-start">Learn More<span>

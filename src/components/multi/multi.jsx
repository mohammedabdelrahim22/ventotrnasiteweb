...
const MultiStepForm = () => {
    ...
    return (
        <div className="p-6 flex justify-center items-center  min-h-[100vh]">
            <div className="min-h-[89vh]">
                <div className="flex flex-col md:flex-row  min-h-[90vh] shadow-lg shadow-cyan-500/50 bg-white">
                        ...
                        <form onSubmit={handleSubmit} className='mt-[60px]'>
                                ...
                                <div className=''>
                                    ...
                                    <div className="flex flex-wrap -mx-3 mb-6 pt-[40px]">
                                        <div className="w-full md:w-1/2 px-3 mb-6 md:mb-0">
                                            <input className="appearance-none block w-full rounded mb-3 bord " id="name" type="text" placeholder="First Name" />
                                        </div>
                                        <div className="w-full md:w-1/2 px-3">
                                            <input className="appearance-none block w-full   rounded bord" id="text" type="text" placeholder="Last Name" />
                                        </div>
                                    </div>
                                    <div className="flex flex-wrap -mx-3 mb-6">
                                        <div className="w-full md:w-1/2 px-3 mb-6 md:mb-0">
                                            <input className="appearance-none block w-full  text-gray-700 rounded  mb-3 bord " id="email" type="email" placeholder="Email" />
                                        </div>
                                        <div className="w-full md:w-1/2 px-3">
                                            <input className="appearance-none block w-full  rounded bord" id="password" type="password" placeholder="*********" />
                                        </div>
                                    </div>
                                </div>
                            )}
                            {currentStep === 2 && (
                                <div className='step_2_form'>
                                    <h2 className='text-[30px] text-black sub_font font-bold '>{stepsTitles[currentStep - 1]}</h2>
                                    <div className="grid grid-cols-1 md:grid-cols-1 gap-4 pm-4 pt-[30px]">
                                        <div>
                                            <select
                                        ...
                                        <div>
                                            ...
                                            <di className="sheckboxes mb-[30px]">
                                            ...
                                            <div className='range_slider'>
                                                <div className="input_style mt-[5px]">
                                                    <div className="flex items-baseline">
                                                        ...
                                                        />
                                                        <span className="max_numper  text-[16px]  text-[#000000] opacity-75 p-2">$50,000</span>
                                                        <h4 className="main_color text-[20px] sub_font pt-5">
                                                            ${rangeValue3}
                                                        </h4>
                    ...
                    <div className="md:w-1/2 flex justify-center items-center bg-[#000000]">

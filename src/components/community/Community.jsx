    ...
    return (
        <div className='Community p-5 mt-[40px] bg-[#F8F8F8] "min-h-[80vh]'>
            ...
            <div className='images_div mt-5'>
                <div className='grid grid-cols-1 sm:grid-cols-3 grid-row-2 gap-1 md:grid-cols-2 lg:grid-cols-3'>
                    {images_cards.map((im) => {
                        return (
                            <div className='image_1 overflow-hidden max-h-[391px]' key={im.id}>
                                <div className='image_inside'>
                                    <img src={im.image} className='object-cover h-[100%]' />
                                </div>
                            </div>
                        )
                    })}
                ...
                <div className='grid grid-cols-1 sm:grid-cols-2 gap-1 md:grid-cols-2 lg:grid-cols-2 mt-3 w-full'>
                    {learn_image.map((i) => {
                        return (
